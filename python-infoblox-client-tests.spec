...
%global pname python_infoblox_client_tests

%global service python-infoblox-client-tests
Name:           %{service}
Version:        0.5.0
Release:        0
...
%description
This project contains Infoblox client
...
It contains the documentation of the Infoblox client package.
